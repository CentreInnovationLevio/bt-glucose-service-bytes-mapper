package com.levio.lab.bt.services.glucose.measurementcontext;

public class GlucoseMeasurementContext {

  private GlucoseMeasurementContextFlags flags;
  ...
  public GlucoseMeasurementContextFlags getFlags() {
    return flags;
  }

  public void setFlags(GlucoseMeasurementContextFlags flags) {
    this.flags = flags;
  }
